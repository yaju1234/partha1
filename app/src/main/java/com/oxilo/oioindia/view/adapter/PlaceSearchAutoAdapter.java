...
public class PlaceSearchAutoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable{
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof EventViewHolder){
            ...
            ((EventViewHolder) holder).placeName.setText(item.getPrimaryText(STYLE_BOLD));
            ((EventViewHolder) holder).placeAddress.setText(item.getSecondaryText(STYLE_NORMAL));
//
